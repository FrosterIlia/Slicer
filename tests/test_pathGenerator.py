...
def test_build_graph():
    ...
    result_graph = path_generator.build_graph(
        QImage(3, 3, QImage.Format.Format_Mono), array)

    assert sorted(result_graph) == sorted(
        expected_graph)  # testing keys in any order
    assert [sorted(i) for i in result_graph.values()] == [sorted(i)
                                                          # testing values in any order
                                                          for i in expected_graph.values()]
...
def test_simplify_path():
    ...
    test2 = [[(0, 0), (1, 0), (2, 0), (3, 1), (4, 2)]]
    # Vertical then horizontal
    test3 = [[(0, 0), (0, 1), (0, 2), (1, 2), (2, 2)]]
    test4 = [[(0, 0), (1, 1), (2, 0), (3, 1), (4, 0)]]  # Zig-zag

    expected_result1 = [(0, 0), "down", (4, 4), "up"]
    expected_result2 = [(0, 0), "down", (2, 0), (4, 2), "up"]
    expected_result3 = [(0, 0), "down", (0, 2), (2, 2), "up"]
    expected_result4 = [(0, 0), "down", (1, 1), (2, 0), (3, 1), (4, 0), "up"]
